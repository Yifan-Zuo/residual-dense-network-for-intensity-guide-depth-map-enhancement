...
with tf.Session() as sess:
    model_path="/media/kenny/Data/trained_models/residual_dense_models/noisy/16x/full_model1/16x_ny_full_model.ckpt-45"
    ...
    #result_img.show()
    result_img.save("/media/kenny/Data/trained_models/residual_dense_models/noisy/16x/results/"+data_name+"16x_result.png")
    ######################computing rmse
