...
LR_dep_art=Image.open("/media/kenny/Data/test_data/noise_free/middlebury_bicubic_LR_test_pairs/"+data_name+"/"+data_name+"4x_bicubic.png")#####for noise-free midd2006
...
with tf.Session() as sess:
    model_path="/media/kenny/Data/trained_models/residual_dense_models/noise_free/4x/l1loss/full_model1/4x_nf_full_model.ckpt-3"
    ...
    #result_img.show()
    result_img.save("/media/kenny/Data/trained_models/residual_dense_models/noise_free/4x/l1loss/results/"+data_name+"4x_result.png")
    ######################computing rmse
