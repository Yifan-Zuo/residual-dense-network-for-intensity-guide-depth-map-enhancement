...
LR_dep_art=Image.open("/media/kenny/Data/test_data/noise_free/middlebury_bicubic_LR_test_pairs/"+data_name+"/"+data_name+"8x_bicubic.png")#####for noise-free midd2006
...
with tf.Session() as sess:
    model_path="/media/kenny/Data/trained_models/residual_dense_models/noise_free/8x/inf_sci_loss_compare/charbloss/full_model1/8x_nf_full_model.ckpt-25"
    ...
    #result_img.show()
    result_img.save("/media/kenny/Data/trained_models/residual_dense_models/noise_free/8x/inf_sci_loss_compare/charbloss/results/"+data_name+"8x_result.png")
    ######################computing rmse
